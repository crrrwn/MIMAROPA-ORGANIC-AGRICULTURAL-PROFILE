        ...
        <form onSubmit={handleSubmit}>
          <div className="bg-white rounded-[2rem] border border-slate-300 shadow-[0_2px_20px_rgb(0,0,0,0.04)] p-6 sm:p-10 relative overflow-hidden">
            ...
            <div className="space-y-12">
              <Section title="General Information" icon="mdi:information-outline">
                <div className="space-y-8">
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
                    <Input label="Date Submitted" type="date" value={form.dateSubmitted} onChange={(v) => update('dateSubmitted', v)} />
                  </div>
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
                  ...
                  <div className="p-5 rounded-2xl bg-slate-50 border border-slate-300">
                    ...
                    <div className="mt-4 flex items-center gap-2 text-sm font-medium text-slate-600 bg-white w-fit px-4 py-2 rounded-lg border border-slate-300">
                  ...
                  <div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-x-2 gap-y-5 mt-5">
              ...
              <Section title="Certification & Organization Background" icon="mdi:certificate-outline">
                  ...
                  <div className="mt-6">
                    ...
                    <div className="space-y-3">
                      {form.specializations.map((s, idx) => (
                        <div key={idx} className="relative p-5 bg-slate-50 rounded-2xl border border-slate-300 hover:border-slate-300 transition-colors">
                          <div className="flex justify-between items-center mb-4">
                            <span className="inline-flex items-center justify-center w-6 h-6 rounded-full bg-white text-slate-500 font-bold text-xs border border-slate-300 shadow-sm">{idx + 1}</span>
                    ...
                    <button type="button" onClick={addSpecialization} className="inline-flex items-center justify-center gap-2 w-full sm:w-auto px-5 py-3 mt-4 rounded-xl border-2 border-dashed border-slate-300 text-slate-600 font-semibold hover:bg-slate-50 hover:border-slate-300 hover:text-slate-800 transition-all active:scale-95 text-sm">
              ...
              <Section title="Shared Facilities and Capacities" icon="mdi:warehouse">
                <div className="space-y-4">
                  ...
                  <button type="button" onClick={addSharedFacility} className="inline-flex items-center justify-center gap-2 w-full sm:w-auto px-5 py-3 rounded-xl border-2 border-dashed border-slate-300 text-slate-600 font-semibold hover:bg-slate-50 hover:border-slate-300 hover:text-slate-800 transition-all active:scale-95 text-sm">
              ...
              <Section title="Machinery, Equipment, and Other Components" icon="mdi:tractor">
                <div className="space-y-4">
                  ...
                  <button type="button" onClick={addMachinery} className="inline-flex items-center justify-center gap-2 w-full sm:w-auto px-5 py-3 rounded-xl border-2 border-dashed border-slate-300 text-slate-600 font-semibold hover:bg-slate-50 hover:border-slate-300 hover:text-slate-800 transition-all active:scale-95 text-sm">
  ...
  return (
    <div className="space-y-2">
      ...
      <input 
        ...
        className="w-full px-4 py-3 rounded-xl border border-slate-300 bg-white text-slate-800 focus:bg-white focus:ring-4 focus:ring-palette-blue/10 focus:border-palette-blue outline-none transition-all placeholder:text-slate-400 font-medium text-sm shadow-sm" 
        {...rest} 
      />
    </div>
  );
    ...
    <div className="space-y-2">
      ...
      <div className="relative">
        <select 
          value={value} 
          onChange={(e) => onChange(e.target.value)} 
          className="w-full px-4 py-3 pr-10 rounded-xl border border-slate-300 bg-white text-slate-800 focus:bg-white focus:ring-4 focus:ring-palette-blue/10 focus:border-palette-blue outline-none transition-all font-medium text-sm shadow-sm appearance-none cursor-pointer"
        >
